window.SportData.views.UploadImportData = Backbone.View.extend({
    ...
    updateProgress: function() {
        ...
        case 'PROGRESS':
            ...
            this.bar.removeClass('alert-info');
            this.bar.removeClass('alert-error');
            this.bar.removeClass('alert-success');
        ...
        case 'DONE':
            ...
            this.bar.removeClass('alert-info');
            this.bar.removeClass('alert-error');
            this.bar.removeClass('alert-warning');
